const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-DIunErYS.js","assets/_commonjsHelpers-BQ54P8Zj.js"])))=>i.map(i=>d[i]);
import { importShared } from './__federation_fn_import-F6uRRWkM.js';
import { a as getAugmentedNamespace, g as getDefaultExportFromCjs } from './_commonjsHelpers-BQ54P8Zj.js';
...
const scriptRel = 'modulepreload';const assetsURL = function(dep) { return "/login-remote-app/"+dep };const seen = {};const __vitePreload = function preload(baseModule, deps, importerUrl) {
...
class RealtimeClient {
    ...
    connect() {
        ...
        __vitePreload(async () => { const {default: WS} = await import('./browser-DIunErYS.js').then(n => n.b);return { default: WS }},true              ?__vite__mapDeps([0,1]):void 0).then(({ default: WS }) => {
...
const supabaseUrl = "https://vrmzllilgpzauysxekch.supabase.co";
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZybXpsbGlsZ3B6YXV5c3hla2NoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDY5NjU0NjMsImV4cCI6MjA2MjU0MTQ2M30.DUIcb9ytDJvtgHScmvEpifAMV9K9p1f_YTrP7q7J-OA";
...
function Login() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: isLogin ? "Login" : "Register" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: isLogin ? "Login" : "Register" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { onClick: () => setIsLogin(!isLogin), style: { cursor: "pointer" }, children: isLogin ? `No account? Create one` : "Already have account? Login" })
      ]
    }
  ) });
}

export { Login as default, jsxRuntimeExports as j };
